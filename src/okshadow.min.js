...
a.pageX=c;a.pageY=b;a.sx=sx;a.sy=sy;a.fuzz=fuzz};a.browsers=" -moz- -webkit- -ms-".split(" ");a.update=function(){var b=a.sx+"px "+a.sy+"px "+a.fuzz+"px "+a.options.color,d=a.options.textShadow?"text-shadow":"box-shadow",c={},e;for(e in a.browsers)c[a.browsers[e]+d]=b;a.$el.css(c);requestAnimFrame(a.update)};a.init()};c.okshadow.options={color:"#888",fuzz:40,fuzzMin:0,fuzzMax:30,xOffset:0,xFactor:30,xMax:30,yOffset:0,yFactor:30,yMax:30,downwards:!0,textShadow:!1,transparent:!1};c.fn.okshadow=function(f){return this.each(function(){new c.okshadow(this,
f)})};window.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(c){window.setTimeout(c,1E3/60)}}()})(jQuery);
